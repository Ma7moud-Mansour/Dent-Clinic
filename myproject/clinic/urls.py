...
urlpatterns = [
    ...
    path('appointments/available/slots/', views.available_slots_by_day, name='available_slots_by_day'),
    ...
    path('invoices/<int:id>/edit/', views.edit_invoice, name='edit_invoice'),
